        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yisheng'">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物医生" prop="yishengId">
                        <el-select v-model="ruleForm.yishengId" :disabled="ro.yishengId" filterable placeholder="请选择宠物医生" @change="yishengChange">
                            <el-option
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="就诊识别码" prop="guahaoUuidNumber">
                       <el-input v-model="ruleForm.guahaoUuidNumber"
                                 placeholder="就诊识别码" clearable  :readonly="ro.guahaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="就诊识别码" prop="guahaoUuidNumber">
                           <el-input v-model="ruleForm.guahaoUuidNumber"
