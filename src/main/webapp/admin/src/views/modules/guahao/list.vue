				...
				<el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
					...
					<el-table-column width="300" :align="contents.tableAlign" header-align="center" label="操作">
						<template slot-scope="scope">
							...
							<el-button v-if="isAuth('guahao','状态') && scope.row.guahaoStatusTypes == 1" type="primary"
								icon="el-icon-edit" size="mini" @click="yijuzhen(scope.row.id)">已就诊</el-button>
							<el-button v-if="isAuth('guahao','取消挂号')&& role == '宠物医生' && scope.row.guahaoStatusTypes == 1" type="primary"
								icon="el-icon-edit" size="mini" @click="tuikuan(scope.row.id,scope.row.yishengId)">退款
							</el-button>
